...
📁 Archivo: 1307_Code_Converttofile_Send_Webhook.json
...
📊 Total de nodos: 25
🏷️  Keywords: code, converttofile, send, webhook
...
📥 PASO 1: Importar el workflow
   ...
   3. Selecciona: 1307_Code_Converttofile_Send_Webhook.json
...
🔐 PASO 2: Configurar credenciales
   ...
   7. Create Potentially Malicious Ticket
      → Tipo: jira
      → Credencial requerida: jiraSoftwareCloudApi
   8. Create Potentially Benign Ticket
      → Tipo: jira
      → Credencial requerida: jiraSoftwareCloudApi
   9. Upload Screenshot of Email to Jira
      → Tipo: jira
      → Credencial requerida: jiraSoftwareCloudApi
   10. Upload Email Body to Jira
      → Tipo: jira
      → Credencial requerida: jiraSoftwareCloudApi
