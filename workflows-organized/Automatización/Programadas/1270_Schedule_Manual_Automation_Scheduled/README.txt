...
📁 Archivo: 1270_Schedule_Manual_Automation_Scheduled.json
...
📊 Total de nodos: 22
🏷️  Keywords: schedule, manual, automation, scheduled
...
📥 PASO 1: Importar el workflow
   ...
   3. Selecciona: 1270_Schedule_Manual_Automation_Scheduled.json

🔐 PASO 2: Configurar credenciales
   1. OpenAI Chat Model
      → Tipo: @n8n/n8n-nodes-langchain.lmChatOpenAi
      → Credencial requerida: openAiApi
   2. SerpAPI - Search Google
      → Tipo: @n8n/n8n-nodes-langchain.toolSerpApi
      → Credencial requerida: serpApi
   3. Google Sheets - Update Row with data
      → Tipo: googleSheets
      → Credencial requerida: googleSheetsOAuth2Api
   4. Get rows to enrich
      → Tipo: googleSheets
      → Credencial requerida: googleSheetsOAuth2Api
