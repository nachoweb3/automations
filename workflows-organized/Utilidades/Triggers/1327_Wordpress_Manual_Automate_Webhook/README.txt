...
📁 Archivo: 1327_Wordpress_Manual_Automate_Webhook.json
...
📊 Total de nodos: 17
🏷️  Keywords: wordpress, manual, automate, webhook
...
📥 PASO 1: Importar el workflow
   ...
   3. Selecciona: 1327_Wordpress_Manual_Automate_Webhook.json

🔐 PASO 2: Configurar credenciales
   1. Get Ideas
      → Tipo: googleSheets
      → Credencial requerida: googleSheetsOAuth2Api
   2. Create post on Wordpress
      → Tipo: wordpress
   ...
   5. Update Sheet
      → Tipo: googleSheets
      → Credencial requerida: googleSheetsOAuth2Api
   6. Generate article with DeepSeek
      → Tipo: @n8n/n8n-nodes-langchain.openAi
      → Credencial requerida: openAiApi
   7. Generate title with DeepSeek
      → Tipo: @n8n/n8n-nodes-langchain.openAi
      → Credencial requerida: openAiApi
