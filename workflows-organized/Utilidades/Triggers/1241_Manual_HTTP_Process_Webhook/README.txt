...
📁 Archivo: 1241_Manual_HTTP_Process_Webhook.json
...
📊 Total de nodos: 15
🏷️  Keywords: manual, http, process, webhook
...
📥 PASO 1: Importar el workflow
   ...
   3. Selecciona: 1241_Manual_HTTP_Process_Webhook.json

🔐 PASO 2: Configurar credenciales
   1. Get YouTube Transcript
      → Tipo: httpRequest
      → Credencial requerida: httpBearerAuth
