...
📁 Archivo: 1105_Manual_Stickynote_Automation_Webhook.json
...
📥 PASO 1: Importar el workflow
   ...
   3. Selecciona: 1105_Manual_Stickynote_Automation_Webhook.json

🔐 PASO 2: Configurar credenciales
   1. Send HTTP Request to OpenAI's TTS Endpoint
      → Tipo: httpRequest
