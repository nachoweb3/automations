...
📁 Archivo: 1248_Gmailtool_Splitout_Automation_Webhook.json
...
📊 Total de nodos: 18
🏷️  Keywords: gmailtool, splitout, automation, webhook
...
📥 PASO 1: Importar el workflow
   ...
   3. Selecciona: 1248_Gmailtool_Splitout_Automation_Webhook.json

🔐 PASO 2: Configurar credenciales
   1. OpenAI Chat Model
      → Tipo: @n8n/n8n-nodes-langchain.lmChatOpenAi
      → Credencial requerida: openAiApi
   2. Notify Client About Tasks
      → Tipo: gmailTool
