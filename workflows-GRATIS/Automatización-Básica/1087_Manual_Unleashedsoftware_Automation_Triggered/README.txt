...
📁 Archivo: 1087_Manual_Unleashedsoftware_Automation_Triggered.json
...
📥 PASO 1: Importar
   ...
   3. Selecciona: 1087_Manual_Unleashedsoftware_Automation_Triggered.json

🔐 PASO 2: Credenciales (GRATIS)
   1. Unleashed Software
      → Tipo: unleashedSoftware
