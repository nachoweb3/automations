╔══════════════════════════════════════════════════════════════════╗
║  1118_Openweathermap_Webhook_Automate_Webhook                    ║
╚══════════════════════════════════════════════════════════════════╝

✅ WORKFLOW 100% GRATUITO

📁 Archivo: 1118_Openweathermap_Webhook_Automate_Webhook.json
...
📥 PASO 1: Importar
   ...
   3. Selecciona: 1118_Openweathermap_Webhook_Automate_Webhook.json
