...
📁 Archivo: 1096_Manual_Linkedin_Automation_Webhook.json
...
3. 📱 Automatización de LinkedIn
   ─────────────────────────────────────────────────────────────
   Publica y monitorea contenido en LinkedIn

   📝 EJEMPLO REAL:
   "Programa posts de LinkedIn con una semana de adelanto"

   🔧 CÓMO IMPLEMENTARLO:
   1. Carga posts programados en Google Sheets
   2. Trigger revisa horarios
   3. Publica en ${platform} automáticamente
   4. Registra métricas de engagement
...
📥 PASO 1: Importar
   ...
   3. Selecciona: 1096_Manual_Linkedin_Automation_Webhook.json
